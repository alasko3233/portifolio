...
const Contact = () => {
    return (
        <>
            <FrontendLayout title="Contactez - moi">
                <Head title="contactez  moi" />

                <div class="w-full flex items-center justify-center my-12">
                    <div class="relative bg-white dark:bg-gray-800 shadow rounded py-4 lg:px-28 px-8">
                        ...
                        <p class="text-xs leading-3 text-gray-600 dark:text-gray-200 mt-4">
                            ...
                            service, privacy policy and how we use data as
                            stated
                        </p>
